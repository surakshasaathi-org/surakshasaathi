...
export default async function DataRequestsPage() {
  ...
  return (
    <AdminShell role={session.role} email={session.email}>
      <h1 className="font-display text-2xl font-semibold tracking-tight">Data requests</h1>
      <p className="mt-2 max-w-prose text-sm text-ink-muted">
        Access, erasure, correction, and portability requests from users. Every request has a 72-hour SLA. The
        queue here shows age, status, and assignee; bulk export writes to Supabase Storage.
      </p>
