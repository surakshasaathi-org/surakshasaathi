...
const FAQS: Record<string, { q: string; a: string }[]> = {
  en: [
    ...
    { q: 'Is my data safe?', a: 'Data is stored on Supabase India (AWS Mumbai), compliant with DPDP Act 2023. You can download or delete your data at any time from your account settings — fulfilled within 72 hours.' },
  ...
  hi: [
    ...
    { q: 'क्या मेरा डेटा सुरक्षित है?', a: 'डेटा Supabase India (AWS Mumbai) पर संग्रहीत है, DPDP Act 2023 के अनुरूप। आप अकाउंट सेटिंग से कभी भी अपना डेटा डाउनलोड या डिलीट कर सकते हैं — 72 घंटे में पूरा होता है।' },
  ...
  kn: [
    ...
    { q: 'ನನ್ನ ಡೇಟಾ ಸುರಕ್ಷಿತವೇ?', a: 'ಡೇಟಾ Supabase India (AWS Mumbai) ನಲ್ಲಿ ಶೇಖರಿಸಲಾಗಿದೆ, DPDP ಕಾಯಿದೆ 2023 ಅನುಸಾರ. ನೀವು ನಿಮ್ಮ ಖಾತೆಯಿಂದ ಡೇಟಾವನ್ನು ಯಾವಾಗ ಬೇಕಾದರೂ ಡೌನ್‌ಲೋಡ್ ಅಥವಾ ಅಳಿಸಬಹುದು — 72 ಗಂಟೆಗಳಲ್ಲಿ ಪೂರ್ಣ.' },
